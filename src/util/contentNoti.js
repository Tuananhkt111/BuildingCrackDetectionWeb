...
export const USER_DISABLE_SUCCESS = "Disable account successfully";
...
export const LOCATION_DISABLE_SUCCESS = "Disable area successfully";
...
export const MAINTENANCEWORKER_DISABLE_SUCCESS = "Disable repairer successfully";
